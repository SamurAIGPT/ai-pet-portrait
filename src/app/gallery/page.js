  ...
  if (status === "loading" || (loading && creations.length === 0)) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center bg-white text-zinc-650">
        <FaSpinner className="animate-spin text-3xl text-rose-500 mb-4" />
    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-zinc-50 px-4 py-12">
        <div className="max-w-md w-full bg-white border border-zinc-200 rounded-2xl p-8 text-center shadow-xl">
          <div className="h-14 w-14 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-500 flex items-center justify-center mx-auto mb-6 shadow-inner animate-pulse">
          ...
          <p className="text-sm text-zinc-550 leading-relaxed mb-8">
            Please sign in to access your HD gallery, view style templates comparison, and download completed pet portraits.
          </p>
          <button
            onClick={() => signIn("google")}
            className="w-full flex items-center justify-center gap-2.5 px-5 py-3.5 rounded-xl text-sm font-extrabold text-white bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-600 hover:to-orange-600 shadow-lg shadow-rose-500/15 active:scale-[0.98] transition-all cursor-pointer"
          >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-500 mt-1.5 font-medium font-sans">Browse your completed high-resolution AI pet portraits</p>
          </div>
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-4.5 py-2.5 bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-600 hover:to-orange-600 text-white text-xs font-extrabold rounded-lg shadow-lg shadow-rose-500/5 transition-all w-fit cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        {creations.length === 0 ? (
          <div className="bg-white border border-zinc-200 rounded-2xl p-12 text-center shadow-lg max-w-xl mx-auto my-12">
            ...
            <Link
              href="/"
              className="inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-600 hover:to-orange-600 text-white text-sm font-extrabold rounded-lg shadow-lg shadow-rose-500/10 cursor-pointer hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            {creations.map((creation) => (
              ...
              >
                ...
                <div className="relative aspect-[4/5] bg-zinc-100 overflow-hidden flex items-center justify-center">
                  ...
                  <span className="absolute top-3 left-3 text-[8px] font-bold text-rose-600 bg-white border border-zinc-200 px-2 py-0.5 rounded-lg shadow uppercase">
                    PET ART
                  </span>
                </div>
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl max-w-2xl w-full p-5 sm:p-6 shadow-2xl relative animate-in fade-in zoom-in duration-200 flex flex-col overflow-hidden max-h-[95vh]" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="flex items-center justify-between border-b border-zinc-200 pb-3 mb-4 flex-shrink-0">
                <div>
                  <h3 className="text-sm sm:text-base font-bold font-heading text-zinc-900 flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-bold text-rose-650 bg-rose-50 border border-rose-200 px-2 py-0.5 rounded-lg uppercase">
                      12 Credits Used
                    </span>
                  </h3>
                </div>
              ...
              <div className="flex-1 flex flex-col md:flex-row gap-6 overflow-y-auto min-h-0 items-center justify-center">
                ...
                <div className="relative w-full max-w-[340px] aspect-[4/5] rounded-xl overflow-hidden border border-zinc-200 bg-zinc-100 shadow-md flex-shrink-0">
                  ...
                  />
                  <div className="absolute top-3 left-3 bg-white/95 backdrop-blur-sm border border-zinc-200 text-rose-650 text-[8px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-lg">
                    Applied Art Overlay
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-4 flex-1 w-full max-w-[320px]">
                  <div className="bg-zinc-50 p-4 border border-zinc-200 rounded-xl space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <span className="text-[8px] text-zinc-450 font-bold block mb-1">Pet Photo</span>
                        <div className="aspect-[1/1] rounded-lg overflow-hidden border border-zinc-200 bg-zinc-100">
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img src={selectedCreation.petImage} alt="Pet Input" className="w-full h-full object-cover" />
                        </div>
                      </div>
                      <div>
                        <span className="text-[8px] text-zinc-450 font-bold block mb-1">Style Template</span>
                        <div className="aspect-[1/1] rounded-lg overflow-hidden border border-zinc-200 bg-zinc-100">
                          {/* eslint-disable-next-line @next/next/no-img-element */}
                          <img src={selectedCreation.referenceImage} alt="Style Reference" className="w-full h-full object-cover" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="border-t border-zinc-200 pt-4 mt-4 flex justify-between items-center gap-3 flex-shrink-0">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-rose-500 to-orange-500 hover:from-rose-600 hover:to-orange-600 text-white rounded-lg text-xs font-bold shadow-lg transition-all cursor-pointer flex items-center gap-1.5 hover:scale-[1.02]"
                  >
